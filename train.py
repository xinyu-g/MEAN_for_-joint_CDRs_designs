...
def parse():
    ...
    ## shared
    parser.add_argument('--cdr_type', type=str, nargs='+', default=['2'], help='types of CDRs to consider')  # Update to list '1', 
    ## for Multi-Channel Attention model
...
def prepare_efficient_mc_att(args):
    ...
    model = EfficientMCAttModel(
        ...
        n_layers=args.n_layers, cdr_type=args.cdr_type, alpha=args.alpha,  # Pass list of CDR types
        n_iter=args.n_iter
    )
...
def main(args):
    ...
    print(f'cdr types: {model.cdr_types}')
